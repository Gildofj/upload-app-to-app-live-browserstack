...
const StdoutCommandName_1 = require("../stdout/StdoutCommandName");
class CommandsStore extends AbstractStore_1.AbstractStore {
    ...
    addStdoutCommand(cmd) {
        ...
        switch (cmd.command) {
            case StdoutCommandName_1.StdoutCommandName.ERROR:
                this.data.errors.push(cmd.message);
                break;
            case StdoutCommandName_1.StdoutCommandName.WARNING:
                this.data.warnings.push(cmd.message);
                break;
            case StdoutCommandName_1.StdoutCommandName.NOTICE:
                this.data.notices.push(cmd.message);
                break;
            case StdoutCommandName_1.StdoutCommandName.DEBUG:
                this.data.debugs.push(cmd.message);
                break;
            case StdoutCommandName_1.StdoutCommandName.SAVE_STATE: {
                // TODO: deprecation
            ...
            case StdoutCommandName_1.StdoutCommandName.ADD_MASK:
                this.data.secrets.push(cmd.message);
                break;
            case StdoutCommandName_1.StdoutCommandName.SET_OUTPUT:
                // TODO: deprecation
                // https://github.blog/changelog/2022-10-11-github-actions-deprecating-save-state-and-set-output-commands/
                if (cmd.properties.name !== undefined) {
                ...
                break;
            case StdoutCommandName_1.StdoutCommandName.ADD_PATH:
                // TODO: deprecation
                // https://github.blog/changelog/2020-10-01-github-actions-deprecating-set-env-and-add-path-commands/
                this.data.addedPaths.push(cmd.message);
                break;
            case StdoutCommandName_1.StdoutCommandName.ECHO:
                if (cmd.message === 'on' || cmd.message === 'off') {
                    this.data.echo = cmd.message;
                }
                break;
            case StdoutCommandName_1.StdoutCommandName.SET_ENV:
                // TODO: deprecation
                // https://github.blog/changelog/2020-10-01-github-actions-deprecating-set-env-and-add-path-commands/
                if (cmd.properties.name !== undefined) {
