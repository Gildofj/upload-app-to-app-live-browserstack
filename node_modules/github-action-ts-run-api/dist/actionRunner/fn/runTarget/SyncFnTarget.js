...
class SyncFnTarget extends AbstractFnTarget_1.AbstractFnTarget {
    ...
    run(options) {
        ...
        const warnings = new WarningsArray_1.WarningsArray(...runMilieu.stdoutInterceptor.parserWarnings);
        try {
            ...
            return new FnRunResult_1.FnRunResult(fnResult, error, durationMs, timedOut, effects, warnings);
        }
        finally {
            runMilieu.restore();
