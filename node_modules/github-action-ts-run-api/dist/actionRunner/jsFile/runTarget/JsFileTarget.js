...
const WarningsArray_1 = require("../../../runResult/warnings/WarningsArray");
class JsFileTarget {
    ...
    run(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const warnings = new WarningsArray_1.WarningsArray(...commandsCollector.deprecationWarnings);
                if (options.outputOptions.data.printWarnings) {
                    warnings.print();
                }
                return new JsFileRunResult_1.JsFileRunResult(commandsCollector.commandsStore.data, spawnResult.error, spawnResult.status !== null ? spawnResult.status : undefined, spawnResult.stdout, spawnResult.stderr, durationMs, effects.runnerDirs.data.temp, effects.runnerDirs.data.workspace, warnings, spawnResult);
            }
            finally {
                runMilieu.restore();
            }
