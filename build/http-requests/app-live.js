...
function getRecentApps() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, api_app_live_1.default.get("/recent_apps")];
                case 1:
                    response = _a.sent();
...
exports.getRecentApps = getRecentApps;
function uploadApp(_a) {
    var appPath = _a.appPath;
    return __awaiter(this, void 0, void 0, function () {
        var customId, form_data, response;
...
function removeApp(_a) {
    var appId = _a.appId;
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, api_app_live_1.default.delete("/app/delete/".concat(appId))];
                case 1:
                    _b.sent();
                    return [2 /*return*/];
            }
