 ...
 */
export declare type ActionConfigSource = ActionConfigInterface | string;
export declare type ActionConfigStoreFilled = ActionConfigStore<ActionConfigInterface>;
export declare type ActionConfigStoreOptional = ActionConfigStore<ActionConfigInterface | undefined>;
export declare type ActionConfigStoreEmpty = ActionConfigStore<undefined>;
